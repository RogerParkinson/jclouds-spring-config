...
/**
 * Tests by writing to an jclouds-test-bucket bucket. 
 * Prerequisites:
 * environment variables jclouds.identity, jclouds.credential must contain valid AWS creds
 * also need env var jclouds.provider: aws-s3
...
public class JcloudsHelperAWSIT {
...
//		Assert.assertFalse("failed to find container",b);
		...
		// Upload the Blob
		blobStore.putBlob("jclouds-test-bucket", blob);
